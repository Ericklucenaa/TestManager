    ...
    <div className="animate-fade">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2rem', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          <select className="form-select" value={ticketFilter} onChange={e => setTicketFilter(e.target.value)} style={{ color: 'var(--accent-secondary)', borderColor: 'var(--accent-secondary)', backgroundColor: 'rgba(249, 115, 22, 0.05)', fontWeight: 'bold' }}>
